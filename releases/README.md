# FRAME – Official Releases

This directory contains the **official, stable releases** of the FRAME. Each release is immutable and reflects the consolidated understanding agreed within FRAME maintainers team at the time of publication.
...
- **tOOLBOX Model Files**
  - `*.mts` — Enterprise Architect toolbox file
  - `*.xmi` — Model exchange file

- **Documentation**
  - Word-exported FRAME documentation (`*.docx`)
